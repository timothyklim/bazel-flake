...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-coIdI7ZysND/nhcPJmpCI8S5jy+LgATg96MS/hRUnug=";
  };
  ...
  bazelBootstrap = stdenv.mkDerivation rec {
    ...
    src = {
      x86_64-linux = fetchurl {
        ...
        hash = "sha256-HyumiOJZZIEdAqDFdCWHD1BeH+eEA4VUnD3uf0EZul8=";
      };
      aarch64-darwin = fetchurl {
        url = "https://github.com/bazelbuild/bazel/releases/download/${version}/bazel-${version}-darwin-arm64";
        hash = "sha256-a1i9RUQ65wnjsBoVbyUXU9iKEVuHYaFuIMzTTxGl43Q=";
      };
  ...
  bazelDeps =
    ...
    stdenv.mkDerivation {
      ...
      patches = [
        ...
        ./patches_7/test_source_sort.patch
      ];
      patchFlags = [
      ...
      outputHash =
        if dryRun then
          ...
          "sha256-5kPyPNBwmhLn5quvmUK7kKoicYGsajcMJCLSRsjoaA4="
        else if stdenv.hostPlatform.system == "aarch64-darwin" then
          "sha256-rPmFMb8iJutmN9UzC2JRoVJUQcIvv7hgj+tp91mFHXE="
